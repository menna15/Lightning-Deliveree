    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (currentState == states["main-menu"])
        {
            ...
            ImGui::Begin("Hello", false, ImGuiWindowFlags_NoBackground |
                                             ...
                                             ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoDecoration); // Create a window called "Hello, world!" and append into it.
...
void our::Application::StyleColorsCustom(ImGuiStyle *dst)
{
    ...
    colors[ImGuiCol_Text] = ImVec4(1.f, 0.0f, 0.0f, 1.00f);
