...
namespace our {
    ...
    class MeshRendererControllerComponent : public Component {
    public:
        ...
        // The ID of this component type is "Mesh Renderer Controller"
        static std::string getID() { return "Mesh Renderer Controller"; }
